...
#People I worked with: Tamariah Davis, Nyia George, and Nylah Omar 
...
.
    ...
    numroom2 = numroom.find_all('span')[2].text

    if "studio" in numroom2.lower():
        numroom2 = 1
    else:
        numroom2 = numroom2.split(" ")[0]
    # print(policynumber, placetype, int(numroom2))
    return(policynumber, placetype, int(numroom2))
...
def write_csv(data, filename):
    ...
    Listing Title,Cost,Listing ID,,Place Type,Number of Bedrooms
